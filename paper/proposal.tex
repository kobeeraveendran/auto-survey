...
% useful for introduction or conclusion sections of literature surveys. 
The single-document summaries allow for more detailed 
coverage on the contributions of each specific paper. By combining both of these, we can can create a comprehensive overview of a problem domain defined by a set of related works. %providing the bulk of a typical related works section.

% I like the disucssion of abstractive vs extractive, however currently feels a bit long and conceptually repetitive
% Prehaps drop the third paragraph or just condense the ideas down a bit.
...
placed on the model, a major challenge shared by all text generation tasks. % absent in extractive approaches. 
...
% Based on proff definition, this is supposed to be future work I think, not current work. Can probably be reflective of both.
